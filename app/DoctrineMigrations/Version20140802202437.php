 ...
 */
class Version20140802202437 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE structure_file_substructure ADD process_id INT DEFAULT NULL, ADD after_id INT DEFAULT NULL, ADD after_yes_id INT DEFAULT NULL, ADD after_no_id INT DEFAULT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE structure_file_substructure DROP process_id, DROP after_id, DROP after_yes_id, DROP after_no_id");
    }
}
