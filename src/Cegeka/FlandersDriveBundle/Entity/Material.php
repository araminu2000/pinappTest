 ...
 * @Solr\Document
 */
class Material extends EntityBase implements ExcelInterface
{
    ...
    /**
     * @var ArrayCollection
     * @ORM\ManyToMany(targetEntity="Cegeka\FlandersDriveBundle\Entity\Step\Paragraph", mappedBy="materials")
     */
