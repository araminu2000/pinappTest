...
/**
 * @ORM\Entity
 * @ORM\Table(name="scaling_application_type")
 */
class ApplicationType extends EntityBase
{
    /**
     * @var string
    ...
    public function deserializeFromXml(XmlDeserializationVisitor $visitor, \SimpleXMLElement $data, DeserializationContext $context)
    {
        ...
        /**
         * @var ApplicationTypeCollection $parentCollection
         */

        $parentCollection = $visitor->getCurrentObject();
        if ($parentCollection instanceof ApplicationTypeCollection) {
